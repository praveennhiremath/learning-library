...
In this lab :
- Using the Graph Studio, We are gonna extract the smaller graph from the main graph as the analysis will be easier and easy to understand as well.
...
5. Fetch TABLE1 and TABLE2 names from edges and combine both names, remove the duplicates by keeping only unique table names. 
   ...
   - 
	...
	The below are the resultant tables
